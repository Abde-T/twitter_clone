...
export default function CommentsPage({ tweetData }) {
  ...
  return (
    <div className="bg-[#2e5070]">
      <div
        className="bg-[#2e5070] min-h-screen text-[#E7E9EA] 
      ...
      >
        ...
        >
          ...
          <div className="border-b border-slate-100">
            <div className="flex space-x-3 p-3 border-slate-100">
              <img
              ...
              <div>
                ...
                {tweetData.image && (
                  <img
                    className="object-cover border border-slate-100 rounded-md mt-3 max-h-80"
                    src={tweetData.image}
                  />
                )}
              </div>
          ...
          <div className="flex justify-between items-center border rounded-lg mt-5 mx-2 p-3  border-slate-100 ">
            ...
            <button
              disabled={true}
              className="bg-slate-100 text-[#242424] rounded-full px-4 py-1.5
          disabled:opacity-50
          "
            >
              Post
          ...
          {tweetData.comments?.map((comment) => (
            <div className="border border-slate-100 rounded-xl mx-2 mt-5">
              <div className="flex space-x-3 p-3 border-slate-100">
                <img
                  className="w-11 h-11 rounded-full object-cover"
