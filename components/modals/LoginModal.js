...
export default function LoginModal() {
  ...
  return (
    <>
      <button
        className="bg-transparent border text-slate-100 border-slate-100 
      ...
      >
        <div
          className="w-[90%] h-[600px] bg-slate-100 text-[#242424] md:w-[560px] md:h-[600px] border border-[#2e5070] border-x-4 border-y-4 shadow-3xl rounded-lg
        flex justify-center
        "
        >
          <div className="w-[90%] mt-8 flex flex-col">
            <h1 className="mt-4 font-bold text-4xl text-[#2e5070]">Sign in to your account</h1>
            <input
              placeholder="Email"
