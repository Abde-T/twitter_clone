  ...
  return (
    <>
      ...
      >
        ...
        rounded-lg bg-slate-100 border border-x-4 border-y-4 shadow-3xl border-[#2e5070]
        sm:w-[600px] sm:h-[386px] text-[#2e5070]
        sm:p-10 p-4
        "
        >
            ...
            <div className="flex space-x-3 w-full">
              ...
              <div>
                ...
                <h1 className="text-gray-500 text-[15px] mt-2">
                  Replying to <span className="text-[#2e5070]">@{tweetDetails.username}</span>
                </h1>
              </div>
            </div>
          </div>
                ...
                <div className="pt-4 flex justify-between border-t border-gray-700">
                  <div className="flex space-x-0">
                    <div className="iconAnimation">
                      <PhotographIcon className="h-[22px] text-[#2e5070] mx-2" />
                    </div>
                    <div className="iconAnimation">
                      <ChartBarIcon className="h-[22px] text-[#2e5070] mx-2" />
                    </div>
                    <div className="iconAnimation">
                      <EmojiHappyIcon className="h-[22px] text-[#2e5070] mx-2" />
                    </div>
                    <div className="iconAnimation">
                      <CalendarIcon className="h-[22px] text-[#2e5070] mx-2" />
                    </div>
                    <div className="iconAnimation">
                      <LocationMarkerIcon className="h-[22px] text-[#2e5070] mx-2" />
                    </div>
                  </div>
                  <button
                    className="bg-[#2e5070] text-slate-100 rounded-full px-4 py-1.5
                  disabled:opacity-50
                  "
                  disabled={!comment}
                  onClick={sendComment}
